...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-[#e6e6f8]">
      {/* Hero Section */}
      <section className="relative pt-40 pb-20 bg-[#2a2943] overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-20 left-10 w-72 h-72 bg-[#00dac4]/20 rounded-full filter blur-3xl animate-blob"></div>
          <div className="absolute top-40 right-10 w-72 h-72 bg-[#c66690]/20 rounded-full filter blur-3xl animate-blob animation-delay-2000"></div>
          <div className="absolute -bottom-8 left-20 w-72 h-72 bg-[#56b4ed]/20 rounded-full filter blur-3xl animate-blob animation-delay-4000"></div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-semibold text-[#2a2943] mb-2">Phone</h3>
              <p className="text-gray-600">+63 991 137 0797</p>
              <p className="text-sm text-gray-500 mt-2">Available for calls</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-semibold text-[#2a2943] mb-2">Email</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg text-center">
              ...
              <h3 className="text-xl font-semibold text-[#2a2943] mb-2">Working Hours</h3>
              <p className="text-gray-600">Monday - Friday</p>
              <p className="text-sm text-gray-500 mt-2">9:00 AM - 6:00 PM PHT</p>
            </div>
          </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-medium text-[#2a2943]">LinkedIn</p>
                    <a 
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <h3 className="text-lg font-semibold text-[#2a2943] mb-4">Connect With Me</h3>
