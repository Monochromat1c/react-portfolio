    ...
    <div className="w-full">
      ...
      <section className="relative min-h-[60vh] bg-[#2a2943] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
          <h1 className="text-4xl sm:text-6xl font-bold text-white mb-6">About Me</h1>
          <p className="text-xl text-[#00dac4] font-medium mb-4">Passionate Web Developer & Tech Enthusiast</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4 relative">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-3xl font-bold text-[#2a2943] mb-6">Personal Journey</h2>
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#2a2943]">Charles Manuel Diestro</h3>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#2a2943]">Location</h3>
                    <p className="text-gray-600">Cogon, Panay, Capiz, Philippines</p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-[#2a2943]">Education</h3>
                    <p className="text-gray-600">BS Information Technology</p>
                    <p className="text-gray-500">Filamer Christian University</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="relative">
              <div className="bg-white rounded-lg p-8 shadow-xl relative z-10">
                <h3 className="text-2xl font-bold text-[#2a2943] mb-6">Professional Summary</h3>
                <p className="text-gray-600 mb-4">
                  As a fourth-year BSIT student, I've developed a strong foundation in both front-end and back-end development. My journey in web development has been driven by a passion for creating intuitive and efficient digital solutions.
                </p>
                <p className="text-gray-600">
                  I specialize in modern web technologies and frameworks, constantly staying updated with the latest industry trends and best practices.
                </p>
              </div>
              {/* Decorative elements */}
        ...
        <div className="max-w-6xl mx-auto px-4 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg p-6 shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-[#2a2943] mb-4">Frontend Development</h3>
            ...
            <div className="bg-white rounded-lg p-6 shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-[#2a2943] mb-4">Backend Development</h3>
              <ul className="space-y-2 text-gray-600">
                <li>• PHP</li>
            ...
            <div className="bg-white rounded-lg p-6 shadow-xl">
              ...
              <h3 className="text-xl font-semibold text-[#2a2943] mb-4">Additional Skills</h3>
              <ul className="space-y-2 text-gray-600">
      ...
      <section className="py-20 bg-[#e6e6f8] relative overflow-hidden animate-on-scroll opacity-0 translate-y-10 transition-all duration-700">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Education Timeline */}
            <div>
              <h2 className="text-3xl font-bold text-[#2a2943] mb-8">Education</h2>
            ...
            {/* Future Goals */}
            <div>
              <h2 className="text-3xl font-bold text-[#2a2943] mb-8">Future Goals</h2>
              <div className="bg-white rounded-lg p-6 shadow-xl">
                <ul className="space-y-4 text-gray-600">
                  <li className="flex items-start gap-3">
                    ...
                    <p>Master advanced web development frameworks and technologies</p>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <p>Contribute to open-source projects and the developer community</p>
                  </li>
                  <li className="flex items-start gap-3">
                    ...
                    <p>Develop innovative web solutions that make a positive impact</p>
                  </li>
                  <li className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-[#00dac4]/10 rounded-full flex items-center justify-center mt-1">
                      <div className="w-2 h-2 bg-[#00dac4] rounded-full"></div>
                    </div>
                    <p>Continue learning and staying updated with industry trends</p>
                  </li>
                </ul>
              </div>
            </div>
