...
const Home = () => {
  ...
  return (
      <div className="w-full">
          ...
          <section className="relative min-h-screen bg-[#2a2943] overflow-hidden">
              ...
              <div className="relative z-10 mt-5 flex flex-col items-center justify-center min-h-screen text-center px-4 bg-[#2a2943]/10">
                  ...
                  <p className="text-lg text-white mb-12 max-w-2xl leading-relaxed drop-shadow-md">
                      Passionate about creating elegant and functional web
                      solutions. Currently focused on full-stack development
          ...
          <section
              id="about"
              className="py-20 bg-[#e6e6f8] relative overflow-hidden animate-on-scroll opacity-0 translate-y-10 transition-all duration-700"
          >
              {/* Animated background elements */}
              ...
              <div className="max-w-6xl mx-auto px-4 relative">
                  <h2 className="text-3xl font-bold text-center mb-12 text-[#2a2943]">
                      About Me
                  </h2>
                  ...
                  <div className="mb-12">
                      <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-100 max-w-2xl mx-auto">
                          ...
                          />
                          <h3 className="text-xl font-semibold mb-2 text-center text-[#2a2943]">
                              Charles Manuel Diestro
                          </h3>
                          <p className="text-[#c66690] font-medium mb-4 text-center">
                              Web Developer
                          </p>
                          <p className="text-gray-600 mb-4 text-center max-w-2xl mx-auto">
                              I am a fourth-year BSIT student at Filamer
                              Christian University, passionate about creating
                              elegant and functional web solutions. My journey
                              in web development has equipped me with both
                          ...
                          <div className="relative pl-4 mb-6">
                              ...
                              <p className="text-gray-600 italic pl-6">
                                  "Aspiring to create meaningful digital
                                  experiences through innovative web
                                  development."
                              </p>
                          </div>
                  ...
                  {/* Skills Carousel */}
                  <div className="mb-12">
                      <h3 className="text-2xl font-semibold text-center mb-8 text-[#2a2943]">
                          Technical Skills
                      </h3>
                              ...
                              {[...skills, ...skills].map((skill, index) => (
                                  <div key={index} className="px-4">
                                      <div className="bg-white rounded-lg p-6 shadow-lg border border-b-4 border-b-[#00dac4] border-gray-100 h-40 flex flex-col items-center justify-center">
                                          {skill.icon}
                                          <h4 className="mt-4 font-medium text-[#2a2943]">
                                              {skill.name}
                                          </h4>
          ...
          <section
              id="projects"
              className="py-20 bg-[#2a2943] animate-on-scroll opacity-0 translate-y-10 transition-all duration-700"
          >
              <div className="max-w-6xl mx-auto px-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                      <div className="bg-white rounded-lg shadow-xl overflow-hidden">
                          ...
                          />
                          <div className="p-6">
                              <h3 className="text-xl font-bold mb-2 text-[#2a2943]">
                                  StepStyle
                              </h3>
                              <p className="text-gray-600 mb-4">
                                  A modern and responsive landing page for a
                                  shoe store, featuring a clean design and
                                  smooth user experience.
                              </p>
                              <div className="flex flex-wrap gap-2 mb-4">
                                  <span className="px-3 py-1 bg-[#00dac4]/10 text-[#00dac4] rounded-full text-sm">
                                      HTML
                                  </span>
                                  <span className="px-3 py-1 bg-[#56b4ed]/10 text-[#56b4ed] rounded-full text-sm">
                                      CSS
                                  </span>
                                  <span className="px-3 py-1 bg-[#c66690]/10 text-[#c66690] rounded-full text-sm">
                                      JavaScript
                                  </span>
                              </div>
                              <a
                  ...
                  <div className="mt-12 text-center">
                      <Link
                          to="/projects"
                          className="inline-block bg-[#00dac4] hover:bg-[#00dac4]/90 text-[#2a2943] font-medium px-8 py-3 rounded-md transition-colors shadow-lg"
                      >
                          View All Projects
                      </Link>
                  </div>
          ...
          <section
              id="contact"
              className="py-20 bg-slate-100 animate-on-scroll opacity-0 translate-y-10 transition-all duration-700"
          >
              <div className="max-w-6xl mx-auto px-4">
                  <h2 className="text-3xl font-bold text-center mb-4 text-[#2a2943]">
                      Get In Touch
                  </h2>
                  ...
                  <div className="bg-white rounded-lg shadow-lg border border-gray-100 p-8 max-w-2xl mx-auto">
                      ...
                      <div className="mt-8 text-center">
                          <Link
                              to="/contact"
                              className="inline-block bg-[#00dac4] hover:bg-[#00dac4]/90 text-[#2a2943] font-medium px-8 py-3 rounded-md transition-colors"
                          >
                              Send Me a Message
                          </Link>
                      </div>
