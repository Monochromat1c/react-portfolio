      ...
      <div className="w-full">
          ...
          <section className="relative pt-[80px] bg-[#2a2943] overflow-hidden">
              ...
              <div className="relative z-10 flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                  ...
                  <p className="text-xl text-white font-medium mb-4 max-w-2xl">
                      Showcasing my journey through web development with
                      projects that demonstrate my skills and passion for
              ...
              <div className="max-w-6xl mx-auto px-4">
                  <div className="grid md:grid-cols-2 gap-8">
                      {projects.map((project) => (
                          <div
                              key={project.id}
                              className="bg-white rounded-lg shadow-xl overflow-hidden transform hover:scale-[1.02] transition-transform duration-300"
                          >
                              ...
                              <div className="p-6">
                                  <h3 className="text-2xl font-bold text-[#2a2943] mb-2">
                                      {project.title}
                                  </h3>
                                  ...
                                  <div className="mb-4">
                                      <h4 className="text-sm font-semibold text-[#2a2943] mb-2">
                                          Key Features:
                                      </h4>
                  ...
                  <div className="mt-12 text-center">
                      <div className="bg-white rounded-lg shadow-xl p-8 max-w-2xl mx-auto">
                          ...
                          <h3 className="text-2xl font-bold mb-4 text-[#2a2943]">
                              More Projects Coming Soon
                          </h3>
                          <p className="text-gray-600">
                              I'm constantly working on new projects and
                              exploring different technologies. Stay tuned for
